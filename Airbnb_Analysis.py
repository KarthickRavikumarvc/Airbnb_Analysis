...
st.set_page_config(
    page_title="AirBnb-Analysis by KARTHICK R!!!",
    page_icon=":bar_chart:",
    layout="wide"
)
...
if SELECT == "Home":
        ...
        with col1:
            ...
            st.subheader(':red[Skills Take Away From This Project:]')
...
if SELECT == "Explore Data":
    ...
    if fl is not None:
        ...
        os.chdir(r"D:\Guvi_Projects\Airbnb_Analysis")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Karthick R"}')
    mail = (f'{"Mail :"}  {"kerebdj4@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/KarthickRavikumarvc",
        "LINKEDIN": "https://www.linkedin.com/in/karthick-ravikumar"
    }
